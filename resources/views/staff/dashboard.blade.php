                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            ...
                            <a href="{{route('staff.staffOrders')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click','#ok_delete',function(){
                $.ajax({
                    type:"delete",
                    url:`{{url('staff/order-destroy')}}/${delete_id}`,
                    headers: {
