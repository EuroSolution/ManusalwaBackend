...
@section('title', 'Area Code Charges')
@section('css')
    <!-- Datatables -->
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Area Code Delivery Charges</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item active">Area Code Delivery Charges</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a class="btn btn-sm btn-primary pull-right addBtn" href="{{route('admin.areaCodeAdd')}}">Add Area Code</a>
                            </div>
                            <div class="col-md-12">
    ...
    <script>
        $(document).ready(function () {
            var DataTable = $("#example1").DataTable({
                ...
                pageLength: 20,
                ajax: {
                    url: `{{route('admin.areaCodeCharge')}}`,
                },
                columns: [
