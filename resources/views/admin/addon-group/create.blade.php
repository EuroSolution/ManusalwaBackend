...
@section('title', (isset($content->id) ?  'Edit' : 'Add').' Addon Group')
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Addon Group</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Addon Group</h3>
                            </div>
                            <form class="category-form" method="post" action="{{!empty($content->id)?route('admin.editAddonGroups',$content->id):route('admin.addAddonGroups')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    @if(Session::has('msg'))
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{route('admin.addonGroups')}}" class="btn btn-warning btn-md">Cancel</a>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
