    ...
    private function createOrder($request){
        ...
        try {
            ...
            try{
                ...
                $this->sendPushNotification(env('APP_NAME'), 'Order placed', route('admin.orders'),[], [Auth::id()]);
                $this->sendPushNotification('New Order', 'Order No#'.$order_no, route('admin.orders'),[], [1]);
